        ...
        <form class="create-form" id="create-form" action="{{ route('kelompokTani.update', $kelompokTani -> id_kelompok_tani)}}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4">
                <div class="mb-3 md:col-span-2">
                    ...
                    <input type="text" id="kelompokTani" name="kelompokTani" value="{{ old('kelompokTani', $kelompokTani->nama_kelompok_tani) }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                </div>
                <div class="mb-3 md:col-span-2">
                    <label for="alamat" class="inline-block mb-2 text-base font-medium">Alamat Sekretariat</label>
                    <input type="text" id="alamat" name="alamat" value="{{ old('alamat', $kelompokTani->alamat_sekretariat) }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                </div>
                <div class="mb-3 md:col-span-2">
