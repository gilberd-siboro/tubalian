        ...
        <form action="{{ route('Adminbantuan.update', $bantuan -> id_bantuan)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4">
                <div class="mb-3 md:col-span-2">
                    ...
                    <input type="text" id="jenis" name="jenis" value="{{ old('jenis', $bantuan->jenis_bantuan) }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                </div>
                <div class="mb-3">
                    <label class="inline-block mb-2 text-base font-medium">Tanggal </label>
                    <input type="date" class="date-input form-input border-slate-200 dark:border-zink-500" value="{{ \Carbon\Carbon::parse($bantuan->tanggal)->format('Y-m-d') }}">
