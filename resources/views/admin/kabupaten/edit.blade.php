...
<div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
    <ul class="flex flex-wrap items-center gap-2 mb-3 font-normal text-15">
        <li
            ...
            <a href="/jenis-status" class="text-slate-500 dark:text-zink-200">Kabupaten</a>
        </li>
...
<div id="Tambah" modal-center=""
    ...
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-beSTEen p-4 border-b dark:border-zink-500">
            <h5 class="text-16" id="addEmployeeLabel">Edit Kabupaten</h5>
            ...
            <form class="create-form" id="create-form" action="#"
                ...
                <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                    <div class="xl:col-span-12">
                        <label for="kabpuaten" class="inline-block mb-2 text-base font-medium">Kabupaten</label>
                        <input type="text" value="#" id="city_name" name="city_name"
