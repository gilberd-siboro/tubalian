        ...
        <form action="{{ route('komoditas.update', $komoditas -> id_komoditas)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="estimasiPanen" oninput="this.value = this.value.replace(/[^0-9]/g, '')" name="estimasiPanen" value="{{ old('estimasiPanen', $komoditas->estimasi_panen) }}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                </div>
